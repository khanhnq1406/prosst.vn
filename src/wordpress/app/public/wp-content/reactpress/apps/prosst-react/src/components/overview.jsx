            ...
            >
              ...
              <div className="content">
                ...
                <div className="box-wrapper">
                  ...
                  <div className="overview-content">
                    AGV robot tự hành trong kho, khung kệ, bảng tên, phần mềm
                    quản lý kho
                  </div>
                  <div className="overview-button">
              ...
              <div className="content">
                ...
                <div className="box-wrapper" style={{ left: "310%" }}>
                  ...
                  <div className="overview-content">
                    Máy tính công nghiệp, camera công nghiệp, thấu kính, đèn
                    công nghiệp, đồ gá, phần mềm chuyên dụng cho vision
                  </div>
                  <div className="overview-button">
                    <button>XEM THÊM...</button>
                  </div>
