...
/**
 * HopeUI\Utility\Nav_Menus class
 *
 * @package hopeui
 */
 ...
 * @version 1.0.0
 */
class HopeUI_Walker_Page extends \Walker_Page
{
    /**
    ...
    public function start_el(&$output, $data_object, $depth = 0, $args = array(), $current_object_id = 0)
    {
        ...
        if (isset($args['pages_with_children'][$page->ID])) {
            ...
            $args['link_before'] = '<div class="hopeui_style-menu-item-wrapper">';
            $args['link_after'] = '<button type="button" class="hopeui_style-menu-toggle  btn" aria-dropdown="false"><i class="fa fa-chevron-right toggledrop hopeui_style-toggleer" aria-hidden="true"></i></button></div>';
        }
        ...
        if ('' === $page->post_title) {
            ...
            $page->post_title = sprintf(__('#%d (no title)','hopeui'), $page->ID);
        }
