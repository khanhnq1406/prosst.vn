<?php
/**
 * HopeUI\Utility\Custom_Header\Component class
 *
 * @package hopeui
 */

namespace HopeUI\Utility\Custom_Header;
...
class Component implements Component_Interface {
	...
	public function wp_head_callback() {
		...
		echo '<style>.site-title a, .site-description { color: #' . esc_attr( $header_text_color ) . '; }</style>';
	}
}
