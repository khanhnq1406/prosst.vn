<?php
/**
 * HopeUI\Utility\Styles\Component class
 *
 * @package hopeui
 */

namespace HopeUI\Utility\Styles;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_enqueue_styles() {
		...
		if ( ! empty( $google_fonts_url ) ) {
			wp_enqueue_style( 'hopeui-fonts', $google_fonts_url, array(), null ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
		}
		...
		foreach ( $css_files as $handle => $data ) {
			...
			$version = hopeui()->get_asset_version( $css_dir . $data['file'] );
	...
	protected function preloading_styles_enabled() {
		 ...
		 */
		return apply_filters( 'hopeui_preloading_styles_enabled', $preloading_styles_enabled );
	}
