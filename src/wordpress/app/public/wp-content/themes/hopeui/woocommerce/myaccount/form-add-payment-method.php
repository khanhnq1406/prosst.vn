	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row p-0 mb-0">
				...
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt  alt  btn btn-hover hopeui_style-button" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'hopeui' ); ?>">
...
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'hopeui' ); ?></p>
<?php endif; ?>
