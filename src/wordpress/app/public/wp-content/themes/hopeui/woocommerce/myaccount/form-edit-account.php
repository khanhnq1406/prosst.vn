...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post"
    ...
    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
        <label for="account_first_name"><?php esc_html_e( 'First name', 'hopeui' ); ?>&nbsp;<span
    ...
    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
        <label for="account_last_name"><?php esc_html_e( 'Last name', 'hopeui' ); ?>&nbsp;<span
                class="required">*</span></label>
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="account_display_name"><?php esc_html_e( 'Display name', 'hopeui' ); ?>&nbsp;<span
                class="required">*</span></label>
        ...
        <span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'hopeui' ); ?></em></span>
    </p>
    <div class="clear"></div>

    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="account_email"><?php esc_html_e( 'Email address', 'hopeui' ); ?>&nbsp;<span
                class="required">*</span></label>
    ...
    <fieldset>
        <legend><?php esc_html_e( 'Password change', 'hopeui' ); ?></legend>

        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            <label
                for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'hopeui' ); ?></label>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            <label
                for="password_1"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'hopeui' ); ?></label>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            <label for="password_2"><?php esc_html_e( 'Confirm new password', 'hopeui' ); ?></label>
    ...
    <p>
        ...
        <!-- save changes button -->
        <button type="submit" class="btn hopeui_style-button woocommerce-Button " name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'hopeui' ); ?>">
            <?php esc_html_e( 'Save changes', 'hopeui' ); ?>
        </button>
