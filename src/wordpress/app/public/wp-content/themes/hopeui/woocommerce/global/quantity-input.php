...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'hopeui' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'hopeui' );
	?>
	<div class="quantity">
		...
		<button type="button" class="minus" ><i class="fas fa-minus"></i></button>
		    <input
			    ...
			    title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'hopeui' ); ?>"
