...
if ( ! wc_ship_to_billing_address_only() && wc_shipping_enabled() ) {
	$get_addresses = apply_filters( 'woocommerce_my_account_get_addresses', array(
		'billing' => esc_html__( 'Billing address', 'hopeui' ),
		'shipping' => esc_html__( 'Shipping address', 'hopeui' ),
	), $customer_id );
} else {
	$get_addresses = apply_filters( 'woocommerce_my_account_get_addresses', array(
		'billing' => esc_html__( 'Billing address', 'hopeui' ),
...
<p>
    <?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'hopeui' ) ); ?>
</p>
            ...
            <address>  <?php
                ...
                <div class="table-responsive">
                    <table>
                        <tbody>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Name","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($name); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Company","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($company); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Country","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($country); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Address","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($address_2); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("E-mail","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($user_email); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Phone","hopeui"); ?></td>
                                <td class="seprator"><span>:</span></td>
